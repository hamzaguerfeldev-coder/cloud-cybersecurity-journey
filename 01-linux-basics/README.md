...
* [tp-linux-basics-corrected-en.md](https://github.com/hamzaguerfeldev-coder/cloud-cybersecurity-journey/blob/main/01-linux-basics/tp-linux-basics-corrected-en.md) — exercise statements, solutions, and detailed reference notes for each exercise.
